                          ...
                          tl: {
                            ...
                            tl: {
                              ...
                              tl: {
                                hd: ">",
                                tl: {
                                  hd: $$String.concat("", List.map(renderToHtmlString, s._5)),
                                  tl: {
                                    hd: "</",
                                    tl: {
                                      hd: tagName,
...
function compareEventHandlerTypes(left, msg) {
  ...
  } else if (left.TAG === /* EventHandlerCallback */0 || !Caml_obj.caml_equal(msg._0, left._0)) {
    return false;
  } else {
    return true;
  }
...
function patchVNodesOnElems_PropertiesApply_Add(callbacks, elem, _idx, s) {
  ...
  switch (s.TAG | 0) {
    case /* RawProp */0 :
        ...
        return ;
    case /* Attribute */1 :
        return Web_node.setAttributeNsOptional(elem, s._0, s._1, s._2);
    case /* Data */2 :
        console.log([
...
function patchVNodesOnElems_PropertiesApply_Remove(_callbacks, elem, _idx, s) {
  ...
  switch (s.TAG | 0) {
    case /* RawProp */0 :
        ...
        return ;
    case /* Attribute */1 :
        return Web_node.removeAttributeNsOptional(elem, s._0, s._1);
    case /* Data */2 :
        console.log([
...
function patchVNodesOnElems_PropertiesApply_Mutate(_callbacks, elem, _idx, oldProp, _newProp) {
  ...
  switch (_newProp.TAG | 0) {
    case /* RawProp */0 :
        ...
        return ;
    case /* Attribute */1 :
        return Web_node.setAttributeNsOptional(elem, _newProp._0, _newProp._1, _newProp._2);
    case /* Data */2 :
        console.log([
...
function patchVNodesOnElems_ReplaceNode(callbacks, elem, elems, idx, param) {
  if (param.TAG === /* Node */2) {
    ...
    var newChild = Web_document.createElementNsOptional(param._0, param._1);
  ...
  while(true) {
    ...
    switch (s.TAG | 0) {
      ...
      case /* Node */2 :
          ...
          var newChild = Web_document.createElementNsOptional(s._0, s._1);
          var match = patchVNodesOnElems_Properties(callbacks, newChild, List.map((function (param) {
                      return /* NoProp */0;
                    }), newProperties), newProperties);
          if (match) {
      ...
      case /* LazyGen */3 :
          var vdom = Curry._1(s._1, undefined);
          s._2.contents = vdom;
          _s = vdom;
          continue ;
      case /* Tagger */4 :
          _s = s._1;
          _callbacks = Curry._1(s._0, callbacks);
          continue ;
...
function wrapCallbacks_On(func, msg) {
  if (typeof msg === "number") {
    return /* Render */0;
  } else if (msg.TAG === /* AddRenderMsg */0) {
    return {
            TAG: /* AddRenderMsg */0,
            _0: Curry._1(func, msg._0)
          };
  } else {
    return {
